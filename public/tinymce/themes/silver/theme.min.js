...
!(function () {
  ...
  const pi = (e, t, o) => {
    ...
    yi = (e, t) =>
      ((e, o) => {
        const n = e.dom;
        return n.parentNode
          ? fi(ze(n.parentNode), (o) => !et(e, o) && Je(o, t))
          : A.none();
      })(e),
        ...
        switch (
          be(Ti.get(), e)
            .orThunk(() => {
              const t = ae(Ti.get());
              return re(t, (t) =>
                e.indexOf(t) > -1 ? A.some(Ti.get()[t]) : A.none()
              );
            })
            .getOr(_i.NORMAL)
        ) {
  ...
  const Ii = x(In(Bi())),
    ...
    Li = (e, t, o) => (
      (() => {
        ...
        if (void 0 !== e.stack) {
          ...
          G(
            t,
            (e) => e.indexOf("alloy") > 0 && !N(Ei, (t) => e.indexOf(t) > -1)
          ).getOr("unknown");
        }
      })(),
      ts(
    ...
    fl = (e, t, o) =>
      Gi(al(e, t), cl(e), o.south(), Ji(), "south", nl(e, { top: 3 }), sl),
    bl = (e, t, o) =>
      Gi(
        ((e) => e.x + e.width)(e),
        dl(e, t),
  ...
  var Ol = Object.freeze({
    ...
    _l = [
      rs("channels", Yn(an.value, Bn([Hi("onReceive"), ws("schema", zn())]))),
    ];
  const Tl = (e, t, o) =>
      ea((n, s) => {
        o(n, e, t);
                  ...
                  const a = (t) => {
                      ...
                      const n =
                        null !== (o = t.raw.pseudoElement) && void 0 !== o
                          ...
                          : "";
                      return (
                        et(t.target, e) && Be(n) && R(uc, t.raw.propertyName)
                      );
                    },
                    i = (r) => {
                      if (m(r) || a(r)) {
                        ...
                        (m(a) || a === sr()) &&
                          (clearTimeout(s), Mt(e, mc), Xa(e, t.classes));
                      }
                    },
                    l = lc(e, rr(), (t) => {
                      a(t) &&
  ...
  const _c = "data-alloy-vertical-dir",
    Tc = (e) =>
      bi(
        e,
        (e) => $e(e) && Tt(e, "data-alloy-vertical-dir") === Oc.BottomToTop
      ),
    Ec = () =>
      xs("layouts", [
        ss("onLtr"),
  ...
  var Sd = [
      ...
      Ui("placement", (e, t, o) => {
        ...
        return A.some(
          Sc({ anchorBox: n, bubble: wc(), overrides: t.overrides, layouts: s })
        );
      }),
    ],
    kd = Qn("type", {
  ...
  var Jd = Object.freeze({
      ...
      isOpen: Yd,
      isPartOf: (e, t, o, n) =>
        Yd(0, 0, o) && o.get().exists((o) => t.isPartOf(e, o, n)),
  ...
  var bu = [
    ...
    xu = [
      Ss(
        "store",
        { mode: "memory" },
        Qn("mode", { memory: yu, manual: vu, dataset: bu })
      ),
      zi("onSetValue"),
      ws("resetOnDom", !1),
    ];
      ...
      ((e, t, o) => {
        ...
        return (
          H(o, (e) => {
            e.fold(
              (e) => {
                n[e.pname] = Du(!0, (t, o, n) =>
                  e.factory.sketch(tm(t, e, o, n))
                );
              },
              (e) => {
  ...
  const Um = Bl({ fields: Pm, name: "disabling", active: Hm, apis: Vm }),
    ...
    $m = (e, t, o) =>
      wi(e.element, "." + t.itemClass).bind((t) =>
        e.getSystem().getByDom(t).toOptional()
      ),
    qm = (e, t, o) => {
  ...
  var Km = Object.freeze({
      ...
      getHighlighted: (e, t, o) =>
        wi(e.element, "." + t.highlightClass).bind((t) =>
          e.getSystem().getByDom(t).toOptional()
        ),
      getFirst: $m,
      getLast: qm,
  ...
  var Mg = Sg(
    ...
    (e, t, o, n) => {
      ...
      return [bg(mg(i), Ag)].concat(
        o.useControlEnter ? [bg(gg([hg, mg(tg)]), Ag)] : []
      );
    },
  ...
  var pp = Sg(
    ...
    Ta.init,
    (e, t, o, n) => {
      const s = [...(o.allowHorizontal ? sg : [])].concat(
          o.allowVertical ? rg : []
        ),
  ...
  const hp = (e, t, o) =>
    ...
    Tp = x([
      ...
      bg(mg(rg), zg(Op)),
      bg(mg(ig), Vg(_p)),
      bg(mg(ng.concat(tg)), (e, t, o) =>
        Ul(e.element).bind((n) => o.execute(e, t, n))
      ),
    ]),
    Ep = x([bg(mg(ng), Tg)]);
  ...
  const Mp = [ss("selector"), ws("execute", _g), ws("moveOnTab", !1)],
    ...
    Rp = x([
      bg(mg(rg), Hg(Ip)),
      bg(mg(ig), Hg(Fp)),
      bg(gg([pg, mg(eg)]), (e, t, o, n) =>
        o.moveOnTab ? Hg(Ip)(e, t, o, n) : A.none()
      ),
      bg(gg([fg, mg(eg)]), (e, t, o, n) =>
        o.moveOnTab ? Hg(Fp)(e, t, o, n) : A.none()
      ),
      bg(mg(tg), Dp),
      bg(mg(ng), Dp),
    ]),
        ...
        return {
          ...
          behaviours: Cu(e.tmenuBehaviours, [
            Yp.config({
              mode: "special",
              onRight: h((e, t) =>
                Om(t.element) ? A.none() : g(e, t, m.HighlightSubmenu)
              ),
    ...
    Yh = km({
      ...
      factory: (e, t) => {
        const o = (t, o, n, s) => {
            ...
            tu.openWhileCloaked(t, o, () =>
              Ad.positionWithinBounds(r, t, n, s())
            ),
              wu.setValue(
                t,
          ...
          n = (t, o, n, s) => {
            const r = ((e, t, o, n, s) => {
              ...
              return qh.sketch({
                ...
                onEscape: () => (
                  tu.close(t), e.onEscape.map((e) => e(t)), A.some(!0)
                ),
                onExecute: () => A.some(!0),
                onOpenMenu: (e, t) => {
        ...
        return {
          ...
          behaviours: Cu(e.inlineBehaviours, [
            tu.config({
              isPartOf: (t, o, n) =>
                Oi(o, n) ||
                ((t, o) => e.getRelated(t).exists((e) => Oi(e, o)))(t, n),
  ...
  var Yf = (function e() {
    let t =
      arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : qf();
    const o = (t) => e(t);
    if (
      ((o.version = "3.0.5"),
      (o.removed = []),
          ...
          if (
            ...
            (fe =
              "ALLOWED_NAMESPACES" in e
                ? kf({}, e.ALLOWED_NAMESPACES, pf)
                : be),
            (ce =
              "ADD_URI_SAFE_ATTR" in e
                ? kf(Cf(de), e.ADD_URI_SAFE_ATTR, xe)
                : de),
            (ie =
              "ADD_DATA_URI_TAGS" in e
                ? kf(Cf(le), e.ADD_DATA_URI_TAGS, xe)
                : le),
            ...
            e.FORBID_CONTENTS &&
              (re === ae && (re = Cf(re)), kf(re, e.FORBID_CONTENTS, xe)),
            oe && (N["#text"] = !0),
    ...
    const Me = function (e) {
      ...
      Ne = function (e) {
        ...
        if (!N[s] || P[s]) {
          if (!P[s] && ze(s)) {
            if (H.tagNameCheck instanceof RegExp && yf(H.tagNameCheck, s))
              return !1;
        ...
        return e instanceof c &&
          ...
          ? (q &&
              ...
              (t = ff(t, M, " ")),
              e.textContent !== t &&
                (mf(o.removed, { element: e.cloneNode() }),
                (e.textContent = t))),
      ...
      (o.sanitize = function (e) {
        ...
        if (
          ...
          if ("function" != typeof e.toString)
            throw xf("toString is not a function");
          if ("string" != typeof (e = e.toString()))
            throw xf("dirty is not a string, aborting");
        }
  ...
  const gb = (e) => (t) => t.options.get(e),
    ...
    hb = (e) => {
      ...
      n("skin", { processor: (e) => r(e) || !1 === e, default: "oxide" }),
        ...
        n("width", {
          processor: a,
          default: db.DOM.getStyle(e.getElement(), "width"),
        }),
    ...
    gv = (e) =>
      (e.options.get("toolbar_sticky") || e.inline) && !dv(e) && !mv(e),
  ...
  const yv = "tox-menu-nav__js",
    ...
    ny = (e, t, o, n, s) => {
      const r =
        ((a = o),
        {
          ...
          components: [
            zh.parts.items({
              preprocess: (e) => Zv(e, (e, t) => "separator" === a[t].type),
            }),
          ],
        });
      var a;
          ...
          components: [
            {
              ...
              components: [
                zh.parts.items({
                  preprocess:
                    "auto" !== e
                      ? Jv({ tag: "div", classes: ["tox-swatches__row"] }, e)
                      : w,
                }),
              ],
            },
    ...
    qy = In(
      [
        ...
        ps(
          "launch",
          Qn("type", { contextformbutton: jy, contextformtogglebutton: Gy })
        ),
      ].concat(Py)
    ),
    ...
    Zy = In(Jy),
    Qy = Mn(() =>
      $n("type", { cardimage: Ky, cardtext: Zy, cardcontainer: ex })
    ),
    ex = In([
      ry,
        ...
        const o = (o) => {
            t.getTooltip().each((n) => {
              n.getSystem().isConnected() &&
                (Vd(n), e.onHide(o, n), t.clearTooltip());
            }),
              t.clearTimer();
          },
          n = (o) => {
            if (!t.isShowing()) {
              ...
              t.setTooltip(s),
                Nd(n, s),
                e.onShow(o, s),
                Ad.position(n, s, { anchor: e.anchor(o) });
            }
          },
          s = (o) => {
            t.getTooltip().each((t) => {
  ...
  const _x = (e, t) => {
    ...
    qx = (e) => {
      const t = e
        .map((e) => ({
          attributes: { id: da("menu-item"), "aria-label": Kf.translate(e) },
        }))
        .getOr({});
  ...
  const Aw = {},
    ...
    Pw = (e, t) =>
      t === Nw && e.options.isSet("color_map_foreground")
        ...
        : Vw("color_map")(e),
    Uw = (e, t = "default") =>
      Math.max(5, Math.ceil(Math.sqrt(Pw(e, t).length))),
    Ww = (e, t) => {
  ...
  const yS = Bl({ fields: bS, name: "coupling", apis: fS, state: vS }),
          ...
          e.bind((e) =>
            A.from(
              qh.sketch({
                ...
                onOpenSubmenu: (e, t, o) => {
                  const n = l().getOrDie();
                  Ad.position(n, o, { anchor: { type: "submenu", item: t } }),
                    tu.decloak(s);
                },
                onRepositionMenu: (e, t, n) => {
                  const s = l().getOrDie();
    ...
    FS = (e, t, o) => {
      ...
      return {
        ...
        behaviours: _u(e.sandboxBehaviours, [
          ...
          Em.config({
            find: (e) => tu.getState(e).bind((e) => Em.getCurrent(e)),
          }),
          Nl.config({
            channels: {
              ...au({ isExtraPart: T }),
    ...
    NS = () => [
      ws("sandboxClasses", []),
      Ou("sandboxBehaviours", [Em, Nl, tu, wu]),
    ],
    LS = x(
      [
        ss("dom"),
        ...
        return {
          ...
          behaviours: Cu(e.dropdownBehaviours, [
            ...
            Yp.config({
              ...
              onEscape: (e, t) =>
                VS.isOpen(e) ? (VS.close(e), A.some(!0)) : A.none(),
            }),
            ch.config({}),
          ]),
          events: yh(
  ...
  const jS = (e, t, o, n, s) => {
      ...
      switch (e.type) {
        ...
        case "separator":
          return ((e) => Xn("separatormenuitem", Iy, e))(e).fold(oy, (e) =>
            A.some(hS(e))
          );
        case "fancymenuitem":
    ...
    GS = (e, t, o, n, s, r, a) => {
      ...
      return we(
        V(e, (e) => {
          switch (e.type) {
            case "separator":
              return ((n = e), Xn("Autocompleter.Separator", Iy, n)).fold(
                oy,
                (e) => A.some(hS(e))
              );
            case "cardmenuitem":
    ...
    YS = (e) =>
      Wc(ze(e.startContainer), e.startOffset, ze(e.endContainer), e.endOffset),
    XS = (e, t) => {
          ...
          return (
            ...
            i.isStopped()
              ...
              : at(e.element).fold(
                  ...
                  (n) => (
                    r.logEventResponse(t, e.element, o.purpose), ak.resume(n)
                  )
                )
          );
        }
    ...
    lk = (e, t, o, n, s, r) =>
      ik(e, t, o, n, s, r).fold(E, (n) => lk(e, t, o, n, s, r), T),
    ck = (e, t, o, n, s) => {
      const r = rk(o, n);
    ...
    mk = (e) => {
      const t = (t) => at(e.element).fold(E, (e) => et(t, e)),
        ...
        s = sk(e.element, {
          triggerEvent: (e, t) =>
            Ai(e, t.target, (o) =>
              ((e, t, o, n) => ck(e, t, o, o.target, n))(n, e, t, o)
            ),
        }),
        r = {
          debugInfo: x("real"),
              ...
              n.field().each((t) => {
                ...
                n.label().each((e) => {
                  ...
                  n["aria-descriptor"]().each((o) => {
                    const n = da(e.prefix);
                    Ot(o.element, "id", n),
                      Ot(t.element, "aria-describedby", n);
                  });
              });
            }),
          ]),
          a = {
            getField: (t) => cm(t, e, "field"),
            getLabel: (t) => cm(t, e, "label"),
          };
        return {
          uid: e.uid,
          dom: e.dom,
            ...
            wu.config({
              ...
              onSetValue: (o, n) => {
                ((o, n) => {
                  ...
                  "auto" === e.columns &&
                    ux(o, 5, "tox-collection__item").each(
    ...
    LO = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = [];
            return {
              field: (t, o) => (e.push(t), sm(IO, RO(t), o)),
              record: x(e),
            };
          })(),
          o = e(t),
        ...
        c = km({
          factory: () => {
            const s = {
              ...
              p = (t) => ({
                label: e(PO + t + ".label"),
                description: e(PO + t + ".description"),
              }),
              h = p("red"),
              f = p("green"),
              b = p("blue"),
            ...
            return vn(
              LO.sketch((o) => ({
                ...
                components: [
                  o.field(
                    "red",
                    hk.sketch(r(mw, "red", h.label, h.description, 255))
                  ),
                  o.field(
                    "green",
                    hk.sketch(r(mw, "green", f.label, f.description, 255))
                  ),
                  o.field(
                    "blue",
                    hk.sketch(r(mw, "blue", b.label, b.description, 255))
                  ),
                  o.field(
                    "hex",
                    hk.sketch(r(ow, "hex", v.label, v.description, "ffffff"))
                  ),
                  i.asSpec(),
                ],
                formBehaviours: Ml([
  ...
  const t_ = (e, t) => {
    ...
    v_ = f_ || b_,
    y_ = h_.isChromium(),
    x_ = ({ scrollTop: e, scrollHeight: t, clientHeight: o }) =>
      Math.ceil(e) + o >= t,
                  ...
                  ((e, t) => {
                    ((e) =>
                      tu
                        ...
                        .bind(Zm.getHighlighted))(e).each((o) => {
                      ((e, t, o, n) => {
                        const s = { ...n, target: t };
                        e.getSystem().triggerEvent(o, t, s);
                      })(
      ...
      V(o, (o) =>
        V_(o)
          ...
          : {
              type: "nestedmenuitem",
              text: o.text,
              getSubmenuItems: () => P_(e, t, o.items, n),
            }
      ),
    U_ = (e, t) =>
      re(e, (e) => (V_(e) ? Ce(e.value === t, e) : U_(e.items, t))),
    W_ = km({
      name: "HtmlSelect",
      configFields: [
        ss("options"),
        ...
        overrides: (e) => ({
          fieldBehaviours: Ml([
            sh("coupled-input-behaviour", [
              jr(er(), (o) => {
                ((e, t, o) => cm(e, t, o).bind(Em.getCurrent))(o, e, t).each(
                  (t) => {
                    cm(o, e, "lock").each((n) => {
            ...
            store: {
              ...
              setValue: (t, o) => {
                ...
                ye(o, e.field1Name) && wu.setValue(n.field1(), o[e.field1Name]),
                  ye(o, e.field2Name) &&
                    wu.setValue(n.field2(), o[e.field2Name]);
              },
            },
          }),
        ]),
    ...
    mT = [
      ...
      rs(
        ...
        Qn("property", {
          width: [
            Ui("property", "width"),
            Ui("getDimension", (e) => Qt(e) + "px"),
          ],
          height: [
            Ui("property", "height"),
            Ui("getDimension", (e) => Gt(e) + "px"),
          ],
        })
      ),
    ];
          ...
          n.setActive(s),
            ...
            o.shared.getSink().each((o) => {
              t()
                ...
                .each((t) => {
                  zl(t.element),
                    Nr(t, Tk, { name: e.name, value: e.storage.get() });
                });
            });
        },
        s = (e) => (t) => {
  ...
  const MT = Bl({ fields: AT, name: "streaming", active: _T, state: ET }),
            ...
            MT.config({
              ...
              onStream: (t, o) => {
                ...
                if (ch.isFocused(t) && Ja(t.element).length >= e.minChars) {
                  const o = i(s).bind((e) =>
                    Zm.getHighlighted(e).map(wu.getValue)
                  );
                  e.previewing.set(!0);
                  const r = (t) => {
                    i(s).each((t) => {
                      o.fold(
                        ...
                        (e) => {
                          Zm.highlightBy(
                            t,
                            (t) => wu.getValue(t).value === e.value
                          ),
                            Zm.getHighlighted(t).orThunk(
                              () => (Zm.highlightFirst(t), A.none())
                            );
                        }
                      );
                    });
    ...
    KT = (e, t) =>
      ((e) => V(e, YT))(((e, t) => U(t, (t) => t.type === e))(e, t)),
                ...
                components: e.url
                  ? [
                      Kh.sketch({
                        ...
                        action: (t) =>
                          Nr(t, Tk, { name: "alert-banner", value: e.url }),
                ...
                const s = ((e, t, o) => {
                    ...
                    return o.getLinkInformation().fold(
                      ...
                      (t) => {
                        const n = tE(
                          a,
                          ((e) => V(e, (e) => XT(e, e)))(o.getHistory(e))
                        );
                        return "file" === e
                          ? ((s = [
                              n,
                              tE(a, JT(t)),
                              tE(a, q([QT(t), ZT(t), eE(t)])),
                            ]),
                            j(
                              s,
                              (e, t) =>
                ...
                Zr((s) => {
                  o.getOpt(s).each((o) => {
                    (QO(e)
                      ...
                      : ZO.load(e.scriptId, e.scriptUrl).then((t) =>
                  ...
                  [`update-active-item-${i}`]: {
                    onReceive: (e, t) => {
                      a.set(A.some(t.value)),
                        nh.set(e, l(A.some(t.value), r.get()));
                    },
                  },
                },
              }),
    ...
    SE = (e, t, o) =>
      Gi(gE(e, t), hE(e), o.insetNorth(), Ji(), "north", nl(e, { top: 2 }), uE),
    kE = (e, t, o) =>
      Gi(
        gE(e, t),
        fE(e, t),
    ...
    OE = (e, t, o) =>
      Gi(mE(e), bE(e, t), o.insetWest(), Qi(), "west", nl(e, { left: 1 }), uE),
    _E = (e) => {
      switch (e) {
        case "north":
          return SE;
    ...
    cA = (e) => {
      ...
      return U(
        ((e) => V(U(e, rA), aA))(t).concat(((e) => V(U(e, oA), iA))(t)),
        lA
      );
    },
    ...
    gA = () => {
      ...
      try {
        ...
        if (e instanceof SyntaxError)
          return (
            console.log("Local storage " + dA + " was not valid JSON", e), {}
          );
        throw e;
      }
      return mA(t)
        ? t
        : (console.log("Local storage " + dA + " was not valid format", t), {});
    },
    pA = (e) => {
      const t = gA();
      return be(t, e).getOr([]);
    ...
    xA = (e) => ({
      ...
      getLinkInformation: () =>
        ((e) =>
          Pb(e)
            ? A.some({
                targets: cA(e.getBody()),
                anchorTop: yA(Ub(e)),
                anchorBottom: yA(Wb(e)),
              })
            : A.none())(e),
    ...
    kA = x([
      ...
      ss("makeItem"),
      ws("setupItem", b),
      Ou("listBehaviours", [nh]),
    ]),
    CA = Ju({
      name: "items",
      overrides: () => ({ behaviours: Ml([nh.config({})]) }),
    }),
    OA = x([CA]),
    _A = Cm({
      name: x("CustomList")(),
  ...
  const iM = Bl({
    ...
    fM = (e, t) => {
      const o = ac(),
        ...
        a = e.inline
          ? []
          : [Nl.config({ channels: { [lM()]: { onReceive: gM } } })];
      return [
        ch.config({}),
        iM.config({
          contextual: {
  ...
  const vM = In(
      [ry, rs("items", Rn([Ln([ay, ms("items", Pn)]), Pn]))].concat(Ry)
    ),
    yM = [
      fs("text"),
      fs("tooltip"),
  ...
  const CM = "container",
    ...
    TM = (e, t) => {
      ...
      return {
        ...
        dom: e.dom,
        components: t,
        behaviours: ku(e.slotBehaviours),
        apis: c,
      };
    },
    EM = ce(
    ...
    AM = {
      ...
      sketch: (e) => {
        const t = (() => {
            const e = [];
            return {
              slot: (t, o) => (e.push(t), sm(CM, _M(t), o)),
              record: x(e),
            };
          })(),
          o = e(t),
    ...
    RM = (e) =>
      Em.getCurrent(e).bind((e) =>
        gT.isGrowing(e) || gT.hasGrown(e)
          ? Em.getCurrent(e).bind((e) =>
              G(AM.getSlotNames(e), (t) => AM.isShowing(e, t))
            )
          : A.none()
      ),
    NM = da("FixSizeEvent"),
  ...
  const HM = Bl({
    ...
    qM = (e, t, o) => {
      ...
      const a = n.concat([r]),
        i = re(a, (e) =>
          Ul(e.element).bind((t) => e.getSystem().getByDom(t).toOptional())
        );
      o([]), $M(s, a);
      const l = ((e, t, o, n) => {
        const s = ((e, t, o) => {
      ...
      0 === l.extra.length
        ? (nh.remove(s, r), o([]))
        : ($M(s, l.within), o(l.extra)),
        Pt(s.element, "visibility"),
        Ut(s.element),
        i.each(ch.focus);
    },
    YM = x([
      Su("splitToolbarBehaviours", [yS]),
      os("builtGroups", () => Ms([])),
    ]),
    XM = x(
      [
                        ...
                        Nl.config({
                          channels: {
                            ...
                            ...lu({
                              doReposition: () => {
                                tu.getState(
                                  yS.getCoupled(e, "toolbarSandbox")
                                ).each((n) => {
                                  oD(e, n, o, t.layouts);
                                });
                              },
        ...
        overrides: (e) => ({
          toolbarBehaviours: Ml([
            ...
            Yp.config({
              mode: "acyclic",
              onEscape: (t) => (
                cm(t, e, "overflow-button").each(ch.focus), A.some(!0)
              ),
            }),
          ]),
        }),
      ...
      factory: (e, t, o, n) => {
        ...
        return {
          ...
          apis: {
            ...
            toggle: (t) => gD(t, e),
            isOpen: (t) =>
              ((e, t) => cm(e, t, "overflow").map(gT.hasGrown).getOr(!1))(t, e),
          },
          domModification: { attributes: { role: "group" } },
        };
      },
      ...
      return AA.sketch({
        ...
        dom: {
          ...
          classes: ["tox-toolbar"].concat(
            e.type === lb.scrolling ? ["tox-toolbar--scrolling"] : []
          ),
        },
  ...
  const zD = SA.optional({
      ...
      factory: {
        sketch: (e) =>
          _A.sketch({
            ...
            dom: e.dom,
            listBehaviours: Ml([
              Yp.config({ mode: "acyclic", selector: ".tox-toolbar" }),
            ]),
            makeItem: () =>
              SD({
                type: e.type,
    ...
    HD = SA.optional({
      factory: {
        sketch: (e) => {
          const t = ((e) =>
            e.type === lb.sliding ? wD : e.type === lb.floating ? xD : SD)(e);
          return t({
            type: e.type,
            uid: e.uid,
            onEscape: () => (e.onEscape(), A.some(!0)),
    ...
    factory: (e, t, o) => {
      ...
      const s = (e) => {
        ...
        a = {
          ...
          whichView: (t) =>
            wA.getPart(t, e, "viewWrapper").bind(LD.whichView).getOrNull(),
          hideMainView: (t) => {
  ...
  const dB = (e, t, o) => {
    ...
    pB = (e) => {
      ...
      return {
        ...
        onAction: (t) => () =>
          G(gB, (e) => e.format === t.format).each((t) =>
    ...
    VB = Xu({
      ...
      overrides: (e) => ({
        ...
        buttonBehaviours: Ml([
          bh.config({ toggleOnExecute: !1, toggleClass: e.toggleClass }),
        ]),
      }),
    }),
    HB = Xu({
    ...
    YB = (e, t, o, n) => {
      ...
      return Kh.sketch({
        ...
        buttonBehaviours: {
          ...
          [O_]:
            null === (s = a.buttonBehaviours) || void 0 === s ? void 0 : s[O_],
        },
      });
      var i;
    },
      ...
      YB(
        e,
        {
          toolbarButtonBehaviours:
            o.length > 0 ? [sh("toolbarButtonWith", o)] : [],
          getApi: WB,
          onSetup: e.onSetup,
        },
        t,
          ...
          ((e, t, o) => {
            const n = Ms(e.tooltip.getOr("")),
              s = (e) => ({
                ...
                isActive: () =>
                  wi(e.element, "span").exists((t) =>
                    e.getSystem().getByDom(t).exists(bh.isOn)
                  ),
                setText: (t) =>
                  wi(e.element, "span").each((o) =>
                    e
      ...
      grouptoolbarbutton: QB(
        ...
        (e, t, o, n) => {
          const s = o.ui.registry.getAll().buttons,
            r = {
              [_c]: t.shared.header.isPositionedAtTop()
                ? Oc.TopToBottom
                : Oc.BottomToTop,
            };
          if (Eb(o) === lb.floating)
    ...
    tI = {
        ...
        ((e, t, o, n) => {
          ...
          const r = Ow(e, "NodeChange SwitchMode", (t) => {
              ...
              (s = A.some(n)),
                ...
                Um.set(n, !e.selection.isEditable());
            }),
            ...
            p = (e) =>
              Hl(e.element)
                ? (ut(e.element).each((e) => zl(e)), A.some(!0))
                : A.none(),
            h = (o, n, s, r) => {
              const i = Ms(b),
          ...
          return {
            ...
            behaviours: Ml([
              ...
              Yp.config({
                ...
                onEscape: (e) =>
                  Hl(e.element) ? A.none() : (zl(e.element), A.some(!0)),
              }),
            ]),
          };
        })(
      ...
      fontfamily: (e, t) =>
        lB(e, t, CB(e), yB, "FontFamilyTextUpdate", "fontfamily"),
                ...
                const a = YD.getToolbar(r.outerContainer),
                  ...
                  u = Ce(
                    ...
                    .map((e) => {
                      ...
                      return (
                        o < e &&
                          It(r.outerContainer.element, "width", s + "px"),
                        { width: s + "px" }
                      );
                    })
      ...
      return {
        ...
        show: () => {
          h.set(!0),
            ...
            w(),
            pv(e)
              ? y((e) => (iM.isDocked(e) ? iM.reset(e) : iM.refresh(e)))
              : y(iM.refresh);
        },
        hide: () => {
          h.set(!1),
  ...
  var hI = Object.freeze({
    ...
    render: (e, t, o, n, s) => {
      ...
      const d = () => {
        ...
        const s = uv(e);
        pv(e)
          ? (Ud(i, r.mothership), Ud(i, t.popupUi.mothership))
          : Pd(s, r.mothership),
  ...
  const fI = "contexttoolbar-hide",
      ...
      const s = n.backstage,
                ...
                sh("context-toolbar-events", [
                  ...
                  jr(AI, (e, o) => {
                    Yh.getContent(e).each((o) => {
                      t.set(
                        t.get().concat([{ bar: o, focus: Pl(bt(e.element)) }])
                      );
                    }),
                      Nr(e, DI, {
        ...
        h = () => {
          if (Yh.isOpen(d)) {
            const e = d.element;
            Pt(e, "display"),
              g() ? It(e, "display", "none") : (l.set(0), Yh.reposition(d));
          }
        },
        f = (t) => ({
          ...
          e.on("contexttoolbar-show", (t) => {
            ...
            be(o.lookupTable, t.toolbarKey).each((o) => {
              x([o], Ce(t.target !== e, t.target)),
                Yh.getContent(d).each(Yp.focusIn);
            });
          }),
          e.on("focusout", (t) => {
            Xh.setEditorTimeout(
    ...
    zI = (e, t) => (o) => {
      ...
      return (
        ...
        Sw(() => e.off("PastePlainTextToggle", n), kw(e)(o))
      );
    },
    VI = (e, t) => () => {
    ...
    OF = (e, t, o, n) =>
      re(e, (e) => {
        ...
        return r
          ? A.some({ output: yF(e.output, t, o, n), extra: e.extra })
          : A.none();
      }),
    _F = (e, t, o, n, s) => {
  ...
  const FF = [
    ...
    RF = (e) => {
      ...
      t.isSome() && o.isSome() && n.isSome()
        ? A.some(
            ((e, t, o) =>
              ("fixed" === o ? SF : xF)(parseInt(e, 10), parseInt(t, 10)))(
              t.getOrDie(),
              o.getOrDie(),
              n.getOrDie()
            )
  ...
  const nR = (e, t, o) => {
                ...
                return (
                  e.hasPlugin("wordcount") &&
                    o.push(
                      ((e, t) => {
                        const o = (e, o, n) =>
                          nh.set(e, [ai(t.translate(["{0} " + n, o[n]]))]);
                        return Kh.sketch({
                          dom: {
                            tag: "button",
                          ...
                          buttonBehaviours: Ml([
                            ...
                            sh("wordcount-events", [
                              ta((e) => {
                                ...
                                wu.setValue(e, { mode: n, count: t.count }),
                                  o(e, t.count, n);
                              }),
                              Zr((t) => {
    ...
    iR = (e, t) => {
      const o = e.inline,
        ...
        y = ((e, t, o, n) => {
          const s = Ms(!1),
            ...
            u = {
              shared: {
                providers: a,
                anchors: NE(t, o, n, r.isPositionedAtTop),
                header: r,
              },
              urlinput: i,
              styles: l,
        ...
        x = () => {
          const t = (() => {
              const t = {
                  attributes: { [_c]: d ? Oc.BottomToTop : Oc.TopToBottom },
                },
                o = YD.parts.menubar({
            ...
            i =
              Gb(e) && !o ? A.some(rR(e, y.popup.shared.providers)) : A.none(),
            l = q([d ? [] : [t], o ? [] : [n], d ? [t] : []]),
            h = YD.parts.editorContainer({
              components: q([l, o ? [] : [g.asSpec()]]),
            }),
            f = mv(e),
            v = {
              role: "application",
            ...
            a = (() => {
              const t = uv(e),
                ...
                n = {
                  ...
                  behaviours: Ml([
                    Ad.config({ useFixed: () => s.isDocked(p) }),
                  ]),
                },
                r = {
    ...
    VR = qn((e) =>
      Xn("customeditor.old", Bn(zR), e).orThunk(() =>
        Xn("customeditor.new", Bn(LR), e)
      )
    ),
    HR = Pn,
    PR = In(OR),
  ...
  const ZN = Bl({
          ...
          apis: {
            ...
            showTab: (e, t) => {
              s(e, (e) => {
                ...
                return G(o, (e) => wu.getValue(e) === t).filter(
                  (t) => !Zm.isHighlighted(e, t)
                );
              });
            },
          },
        ...
        ZN.config({
          ...
          renderComponents: (e) => {
            ...
            return "tabpanel" === t.type
              ? [bL(t, e.initialData, n)]
              : [eL(t, e.initialData, n)];
          },
          initialData: e,
        }),
      ]),
      ...
      return uR.sketch({
        ...
        parts: {
          blocker: {
            ...
            components: [
              { dom: { tag: "div", classes: yL ? [n, n + "--opaque"] : [n] } },
            ],
          },
        },
        dragBlockClass: o,
    ...
    TL = (e) =>
      Kh.sketch({
        ...
        components: [
          rb("close", { tag: "span", classes: ["tox-icon"] }, e.icons),
        ],
        action: (e) => {
          Rr(e, _k);
        },
    ...
    WL = (e, t, o) => {
      ...
      return [
        ...
        n(Tk, (e, t, n, s) => {
          const r = () =>
              s.getSystem().isConnected() ? Yp.focusIn(s) : void 0,
            a = (e) =>
              At(e, "disabled") ||
    ...
    XL = (e, t, o, n = !1, s) => {
      const r = da("dialog"),
        ...
        h = Ce(
          0 !== g.length,
          Zh(((e, t, o) => GL(e, t, o))({ buttons: g }, r, o))
        ),
        f = WL(
          () => v,
          {
  ...
  const JL = [
    ...
    QL = (e, t, o, n) => {
      const s = da("dialog"),
        ...
        c = e.buttons.bind((e) =>
          0 === e.length ? A.none() : A.some($L({ buttons: e }, s, n))
        ),
        u = ((e, t) => {
          const o = (e, t) =>
              jr(e, (e, o) => {
